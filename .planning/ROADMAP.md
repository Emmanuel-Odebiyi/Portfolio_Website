...
- [ ] **Phase 1: Dependency Cleanup** - Purge Tina CMS remnants and standardize local markdown post schemas.
...
Plans:
- [ ] 01-01: Remove unused Tina packages and align blog markdown keys
...
Plans:
- [ ] 03-01: Adjust 3D components for mobile device viewports
...
|-------|----------------|--------|-----------|
| 1. Dependency Cleanup | 0/1 | Not started | - |
