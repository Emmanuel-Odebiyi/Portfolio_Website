  ...
  return (
    <div className="pt-32 pb-20 bg-white selection:bg-emerald-100 selection:text-emerald-900">
      <section className="max-w-4xl mx-auto px-6">
        <Link to="/about" className="inline-flex items-center gap-2 text-zinc-500 hover:text-emerald-600 transition-colors mb-12 group">
        ...
        <div className="space-y-16">
          <div className="space-y-6">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 text-emerald-600 text-xs font-mono tracking-[0.2em] uppercase"
            >
          ...
          <div className="prose prose-zinc prose-2xl font-light text-zinc-600 leading-relaxed space-y-12">
            ...
            <div className="pt-20 text-center">
              <Link 
                to="/contact"
                className="inline-flex items-center gap-3 px-10 py-5 bg-zinc-900 text-white font-bold rounded-2xl hover:bg-emerald-600 transition-all shadow-xl shadow-zinc-200"
              >
