    ...
    <div className="min-h-screen bg-white text-zinc-900 selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <article className="max-w-3xl mx-auto px-6 py-32">
        ...
        <section className="mb-20">
          <p className="text-3xl md:text-4xl font-light text-zinc-500 leading-relaxed italic border-l-4 border-emerald-500 pl-8">
            {post.hook}
          </p>
        </section>
        ...
        <div className="space-y-24">
          {post.sections.map((section, index) => (
            <section key={index} className="space-y-8">
              ...
              {section.highlight && (
                <div className="p-10 rounded-[2.5rem] bg-emerald-50 border border-emerald-100 space-y-4">
              ...
              {section.simplification && (
                <div className="p-10 rounded-[2.5rem] bg-zinc-900 text-white space-y-6 relative overflow-hidden">
                  <div className="relative z-10">
                    <h4 className="text-xs font-mono uppercase tracking-[0.3em] text-emerald-400 mb-4">
        ...
        <section className="p-12 md:p-20 rounded-[4rem] bg-zinc-50 border border-zinc-100 space-y-12">
          ...
          <ul className="space-y-6">
            {post.takeaways.map((takeaway, i) => (
              <li key={i} className="flex items-start gap-4 group">
                <div className="mt-1.5 w-5 h-5 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center flex-shrink-0 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
        ...
        <section className="mt-20 pt-12 border-t border-zinc-100">
          <p className="text-zinc-500 font-light">
            Interested in seeing more? <Link to="/portfolio" className="text-emerald-600 font-bold hover:underline inline-flex items-center gap-1">View my portfolio <ArrowUpRight size={16} /></Link>, <Link to="/resume" className="text-zinc-900 font-bold hover:underline">check my resume</Link>, or <Link to="/contact" className="text-emerald-600 font-bold hover:underline">get in touch</Link>.
          </p>
        </section>
                ...
                <div className="space-y-2">
                  <div className="flex gap-2">
                    {related.tags.slice(0, 2).map(tag => (
                      <span key={tag} className="text-[10px] font-mono uppercase tracking-widest text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded">
                        {tag}
                      </span>
                    ))}
                  </div>
                  <h4 className="text-xl font-bold text-zinc-900 leading-tight group-hover:text-emerald-600 transition-colors">
                    {related.title}
                  </h4>
