...
export default function MyApproach() {
  return (
    <div className="pt-32 pb-20 bg-white selection:bg-indigo-100 selection:text-indigo-900">
      <section className="max-w-4xl mx-auto px-6">
        <Link to="/about" className="inline-flex items-center gap-2 text-zinc-500 hover:text-indigo-600 transition-colors mb-12 group">
        ...
        <div className="space-y-16">
          <div className="space-y-6">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-50 text-indigo-600 text-xs font-mono tracking-[0.2em] uppercase"
            >
          ...
          <div className="prose prose-zinc prose-2xl font-light text-zinc-600 leading-relaxed space-y-12">
            <p className="text-3xl font-bold text-indigo-600 leading-tight">
            ...
            <div className="pt-20 text-center">
              <Link 
                to="/contact"
                className="inline-flex items-center gap-3 px-10 py-5 bg-zinc-900 text-white font-bold rounded-2xl hover:bg-indigo-600 transition-all shadow-xl shadow-zinc-200"
              >
