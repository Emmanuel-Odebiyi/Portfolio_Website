              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 border-t border-zinc-100">
                <div className="space-y-2">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-bold text-emerald-500">+{gap.percent}%</span>
              ...
              <div className="bg-zinc-900 rounded-[3rem] p-10 md:p-16 text-white relative overflow-hidden">
                <div className="relative z-10 space-y-10 max-w-xl">
                  ...
                  <form onSubmit={handleUnlock} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-4 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all placeholder:text-zinc-600"
                        />
                      </div>
                      <div className="relative">
                    ...
                    <button 
                      disabled={loading}
                      className="w-full py-5 bg-emerald-500 text-zinc-900 font-bold rounded-2xl hover:bg-emerald-400 transition-all flex items-center justify-center gap-2 group disabled:opacity-50"
                    >
                          ...
                          <tr key={row.month} className="hover:bg-zinc-50 transition-colors group">
                            ...
                            <td className="px-8 py-6">
                              <div className="flex flex-col">
                                ...
                                <span className="text-emerald-600 font-bold">{row.autopilotVisitors.toLocaleString()}</span>
                              </div>
                            </td>
                            <td className="px-8 py-6">
                              <div className="flex flex-col">
                                <span className="text-zinc-400 text-xs line-through">{row.manualLeads.toLocaleString()}</span>
                                <span className="text-emerald-600 font-bold">{row.autopilotLeads.toLocaleString()}</span>
                              </div>
                            </td>
                            <td className="px-8 py-6">
                              <div className="flex flex-col">
                                <span className="text-zinc-400 text-xs line-through">{formatCurrency(row.manualRevenue)}</span>
                                <span className="text-emerald-600 font-bold">{formatCurrency(row.autopilotRevenue)}</span>
                              </div>
                            </td>
                          </tr>
                        ))}
                ...
                <div className="bg-zinc-900 rounded-[4rem] p-12 md:p-20 text-center space-y-10 relative overflow-hidden">
                  <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                    ...
                    <div className="pt-4">
                      <Link 
                        to="/contact"
                        className="px-10 py-5 bg-emerald-500 text-zinc-900 font-bold rounded-2xl hover:bg-emerald-400 transition-all shadow-2xl shadow-emerald-500/20 inline-flex items-center gap-3 group"
                      >
