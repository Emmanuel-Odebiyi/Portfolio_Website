...
export default function ROITimeMachine() {
  ...
  const results = useMemo(() => {
    ...
    const chartData: ROIData[] = Array.from({ length: 13 }, (_, i) => {
      ...
      const automationCost = i === 0 ? inputs.setupInvestment : inputs.setupInvestment; // Setup cost is one-time, but for cumulative comparison we keep it
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-zinc-200 rounded-2xl px-6 py-4 text-zinc-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all appearance-none cursor-pointer"
                  >
                    {CURRENCIES.map((curr) => (
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-bold text-emerald-600">{inputs.weeklyHours}h</span>
                  </div>
                  <input 
                    type="range"
                    min="1"
            ...
            <div className="bg-zinc-900 rounded-[3rem] p-10 text-white relative overflow-hidden">
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="space-y-2 min-w-0">
                  ...
                  <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-emerald-400 break-words">
              ...
              <div className="bg-zinc-50 rounded-[3rem] p-10 border border-zinc-200 shadow-xl shadow-zinc-200/50 space-y-8">
                ...
                <form onSubmit={handleUnlockReport} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <input 
                    ...
                    className="bg-white border border-zinc-200 rounded-2xl px-6 py-4 text-zinc-900 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all"
                  />
                  <input 
                    required
                    type="email"
                  ...
                  <button
                    type="submit"
                    className="py-4 bg-zinc-900 text-white font-bold rounded-2xl hover:bg-emerald-600 transition-all flex items-center justify-center gap-2 group"
                  >
              ...
              >
                ...
                <div className="bg-white p-10 rounded-[3rem] border border-zinc-100 shadow-xl shadow-zinc-200/50 space-y-8">
                  ...
                  <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-bold text-emerald-900">ROI Milestone: Month 3</p>
                      ...
                      <tbody className="divide-y divide-zinc-100">
                        {results.chartData.slice(1).map((row) => (
                          <tr key={row.month} className="hover:bg-zinc-50 transition-colors">
                            ...
                            <td className="px-8 py-4 text-emerald-600 font-bold">+{formatCurrency(row.netSavings)}</td>
                            <td className={`px-8 py-4 font-bold ${row.cumulativeSavings >= 0 ? 'text-emerald-600' : 'text-orange-500'}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                      ...
                      <p className="text-sm text-zinc-500 font-light">
                        You are currently projecting <span className="text-white font-bold">{inputs.weeklyHours}h</span> in weekly savings, which is <span className="text-emerald-400 font-bold">{Math.round((inputs.weeklyHours / BENCHMARK_HOURS) * 100)}%</span> of the industry benchmark.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-32 bg-zinc-900 rounded-[4rem] p-12 md:p-24 text-center space-y-12 relative overflow-hidden">
          <div className="relative z-10 space-y-8 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tight">
              ...
              <span className="text-emerald-500">system for you?</span>
            </h2>
            ...
            <div className="pt-8">
              <Link 
                to="/services"
                className="px-12 py-6 bg-white text-zinc-900 font-bold rounded-2xl hover:bg-emerald-500 hover:text-white transition-all shadow-2xl shadow-emerald-500/20 inline-flex items-center gap-3 group"
              >
