      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
          <Link
            ...
            className="flex items-center gap-2 text-zinc-900 font-bold hover:text-emerald-600 transition-colors"
          >
            <ArrowLeft size={20} />
            Back to Lab
          </Link>
          ...
          <Link
            to="/services"
            className="px-8 py-4 bg-zinc-900 text-white font-bold rounded-2xl hover:bg-emerald-600 transition-all shadow-xl shadow-zinc-200"
          >
            Explore Services
          </Link>
        </div>
