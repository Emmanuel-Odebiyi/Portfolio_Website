    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {options.map((opt) => (
          ...
          >
            {opt}
            {formData[field] === opt && <CheckCircle2 size={16} className="text-emerald-400" />}
          </button>
        ))}
      </div>
    </div>
                ...
                <div className="flex items-center justify-between pt-8 border-t border-zinc-200">
                  ...
                  {formStep < 3 ? (
                    <button
                      ...
                      className="px-8 py-4 bg-zinc-900 text-white font-bold rounded-2xl hover:bg-emerald-600 transition-all flex items-center gap-2"
                    >
                      Next Step
                    ...
                    <button
                      ...
                      className="px-8 py-4 bg-emerald-500 text-white font-bold rounded-2xl hover:bg-emerald-600 transition-all flex items-center gap-2 shadow-lg shadow-emerald-200"
                    >
                      Calculate Score
                      <Zap size={20} />
                    </button>
          ...
          {step === 'loading' && (
            ...
            >
              <div className="relative">
                <div className="w-24 h-24 rounded-full border-4 border-zinc-100 border-t-emerald-500 animate-spin" />
                  ...
                  <div className="p-10 rounded-[3rem] bg-zinc-900 text-white space-y-6 relative overflow-hidden">
                    <div className="relative z-10 space-y-4">
                      ...
                      <div className="pt-6 flex items-start gap-4">
                        ...
                        <div className="space-y-1">
                          <p className="text-sm font-mono text-zinc-500 uppercase tracking-widest">Biggest Bottleneck</p>
                    ...
                    {!isEmailUnlocked ? (
                      <form onSubmit={handleUnlockReport} className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full px-6 py-4 rounded-xl bg-zinc-50 border border-zinc-100 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all"
                          />
                        </div>
                        <div className="space-y-2">
                        ...
                        <button
                          type="submit"
                          className="w-full py-5 bg-zinc-900 text-white font-bold rounded-xl hover:bg-emerald-600 transition-all flex items-center justify-center gap-2 group"
                        >
                      ...
                      <div className="space-y-6">
                        <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center gap-4">
                          ...
                          <p className="text-sm font-medium text-emerald-900">Full report unlocked for {name}</p>
                        </div>
                        <button
                          onClick={() => document.getElementById('full-report')?.scrollIntoView({ behavior: 'smooth' })}
                          className="w-full py-5 bg-zinc-900 text-white font-bold rounded-xl hover:bg-emerald-600 transition-all flex items-center justify-center gap-2"
                        >
                          View Breakdown ↓
                        </button>
                      </div>
                    ...
                    {[
                      ...
                      <div key={cat.id} className="p-10 rounded-[3rem] bg-zinc-50 border border-zinc-100 space-y-8">
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="space-y-2">
                            <p className="text-[10px] font-mono text-emerald-500 uppercase tracking-widest">The Fix</p>
                  ...
                  <div className="bg-zinc-900 rounded-[4rem] p-12 md:p-24 text-center space-y-12 relative overflow-hidden">
                    <div className="relative z-10 space-y-8 max-w-3xl mx-auto">
                      <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tight">
                        Ready to move from <span className="text-emerald-500">{results.tier}</span> to Autopilot?
                      </h2>
                      <p className="text-xl text-zinc-400 font-light leading-relaxed">
