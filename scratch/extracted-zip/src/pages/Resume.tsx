...
export default function Resume() {
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20 selection:bg-emerald-100 selection:text-emerald-900 font-sans">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            <div className="space-y-4">
              <motion.h1 
                ...
                className="text-7xl md:text-8xl font-bold text-zinc-900 tracking-tighter leading-none"
              >
                Emmanuel <br /> Odebiyi
              </motion.h1>
              <motion.p 
            ...
            >
              <div className="flex flex-col gap-2 text-sm font-mono uppercase tracking-widest text-zinc-500">
                <a href="mailto:emmayoodebiyi001@gmail.com" className="hover:text-emerald-600 transition-colors">emmayoodebiyi001@gmail.com</a>
              ...
              <AnimatePresence mode="wait">
                {!isPageLoaded ? (
                  ...
                  <motion.button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-zinc-900 text-white text-xs font-bold rounded-full hover:bg-emerald-600 transition-all shadow-xl shadow-zinc-200 uppercase tracking-widest"
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-20">
          ...
          <div className="space-y-32">
            ...
            <section id="summary" className="space-y-8">
              ...
              <p className="text-3xl md:text-5xl text-zinc-900 font-bold leading-[1.1] tracking-tighter max-w-4xl">
                I build <span className="text-emerald-500">autonomous growth engines</span> for SaaS companies. By combining AI-driven workflows with high-intent SEO strategy, I help brands scale their content operations and capture market share without increasing headcount.
              </p>
                  ...
                  <div key={i} className="grid grid-cols-1 md:grid-cols-[1fr_200px] gap-8 group">
                    <div className="space-y-6">
                      <div className="space-y-1">
                        <h3 className="text-2xl font-bold text-zinc-900 tracking-tight group-hover:text-emerald-600 transition-colors">{job.role}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  ...
                  <Link 
                    key={i} 
                    to={project.link}
                    className="p-10 rounded-[2rem] bg-zinc-50 hover:bg-emerald-50 transition-all group border border-transparent hover:border-emerald-100"
                  >
                    <div className="flex justify-between items-start mb-6">
                      <h3 className="text-2xl font-bold text-zinc-900 tracking-tight">{project.title}</h3>
                      <ExternalLink size={20} className="text-zinc-300 group-hover:text-emerald-500 transition-colors" />
                    </div>
            ...
            <section id="certifications" className="space-y-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-6 border border-zinc-100 rounded-2xl hover:border-emerald-200 transition-colors">
            ...
            <footer className="pt-24 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <div className="flex gap-8">
                <a href="#" className="text-xs font-bold uppercase tracking-widest text-zinc-400 hover:text-emerald-600 transition-colors">LinkedIn</a>
                <a href="#" className="text-xs font-bold uppercase tracking-widest text-zinc-400 hover:text-emerald-600 transition-colors">Twitter</a>
                <a href="mailto:emmayoodebiyi001@gmail.com" className="text-xs font-bold uppercase tracking-widest text-zinc-400 hover:text-emerald-600 transition-colors">Email</a>
              </div>
            </footer>
