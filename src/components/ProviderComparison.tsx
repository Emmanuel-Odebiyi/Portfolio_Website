...
const comparisonData = [
  {
    title: "Agencies",
    icon: <Building2 size={24} className="text-deep-space-blue-500" />,
    advantages: [
  ...
  {
    title: "Freelancers",
    icon: <UserX size={24} className="text-deep-space-blue-500" />,
    advantages: [
  ...
  {
    title: "DIY",
    icon: <MousePointer2 size={24} className="text-deep-space-blue-500" />,
    advantages: [
  ...
  },
  {
    ...
    icon: <Users size={24} className="text-deep-space-blue-500" />,
    advantages: [
...
export const ProviderComparison: React.FC = () => {
  return (
    <section className="py-32 bg-white text-zinc-900 relative overflow-hidden">
      {/* Background Accent */}
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-deep-space-blue-500/5 blur-[120px] rounded-full pointer-events-none -translate-y-1/2 translate-x-1/3" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center space-y-6 mb-24 cursor-default">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="inline-block text-deep-space-blue-500 font-mono font-bold text-xs uppercase tracking-[0.3em] bg-deep-space-blue-500/10 px-4 py-1.5 rounded-full"
          >
            The Difference
          </motion.h2>
          <motion.h3 
              ...
              <ul className="space-y-6">
                {col.advantages.map((adv, j) => (
                  <li key={j} className="flex gap-4 group">
                    <CheckCircle2 size={20} className="text-deep-space-blue-500 shrink-0 mt-0.5 group-hover:scale-110 transition-transform" />
