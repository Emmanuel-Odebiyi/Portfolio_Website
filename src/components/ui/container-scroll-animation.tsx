...
export const ContainerScroll = ({
  ...
  // Phase 2 (5–80%): Tab stays at reading angle while text scrolls
  // Phase 3 (80–95%): Tab straightens to 0°
  ...
  return (
    ...
    >
      <div
        className="w-full sticky top-0 h-screen flex flex-col items-center justify-center pt-12 md:pt-20 overflow-hidden"
        style={{
          perspective: "1000px",
        }}
      >
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[95vw] lg:max-w-6xl mt-4 md:mt-8 mx-auto h-[70vh] w-full border-[8px] md:border-[16px] border-[#1f1f1f] p-2 md:p-3 bg-[#111111] rounded-[2rem] md:rounded-[3rem] shadow-2xl relative"
    >
