...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[95vw] lg:max-w-6xl mt-4 md:mt-8 mx-auto h-[60vh] md:h-[70vh] w-full border-[8px] md:border-[16px] border-[#1f1f1f] p-2 md:p-3 bg-[#111111] rounded-[2rem] md:rounded-[3rem] shadow-2xl relative"
    >
