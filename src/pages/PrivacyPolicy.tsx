      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-gray-500 font-mono text-xs uppercase tracking-widest">Last Updated: March 24, 2026</p>
          </div>

          <div className="prose prose-invert prose-lg max-w-none font-light text-gray-400 leading-relaxed space-y-8">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white tracking-tight">2. Information I Collect</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white tracking-tight">3. How I Use Your Information</h2>
              <p>
              ...
              <p className="font-medium text-white">I do not sell, rent, or trade your personal information to third parties.</p>
            </section>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white tracking-tight">5. Third-Party Services</h2>
              <p>
