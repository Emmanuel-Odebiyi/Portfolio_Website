...
export default function TermsOfService() {
  return (
    <div className="pt-32 pb-20 bg-[#0B0F19] text-white min-h-screen font-sans">
      <SEO 
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          <div className="space-y-4">
            <h1 className="text-5xl md:text-6xl font-bold text-white tracking-tight">Terms of Service</h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none font-light text-gray-400 leading-relaxed space-y-8">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-white tracking-tight">2. Use of Site and Tools</h2>
              <p>
