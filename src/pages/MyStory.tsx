        ...
        <div className="space-y-16">
          <div className="space-y-6">
            ...
            <h1 className="text-6xl md:text-8xl font-bold tracking-tight leading-[1.05] text-white">
              My <span className="text-gray-500">Story.</span>
            </h1>
          </div>
          ...
          <div className="prose prose-invert prose-2xl font-light text-gray-400 leading-relaxed space-y-12">
            ...
            <div className="aspect-video rounded-[3rem] bg-white/5 overflow-hidden border border-white/10">
              <video 
            ...
            <div className="p-12 rounded-[3rem] bg-white/5 border border-white/10 backdrop-blur-md space-y-8 shadow-xl">
              <h3 className="text-3xl font-bold text-white">The Turning Point</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {['AI Efficiency', 'Human Strategy', 'Systematic Processes'].map((item) => (
                  <div key={item} className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
