...
const OptionCard = ({ selected, onClick, icon: Icon, label, desc }: any) => (
  <button
    ...
    className={`w-full p-6 rounded-[2rem] border text-left transition-all duration-300 group ${
      selected 
        ? 'bg-white/10 border-white/20 text-white shadow-xl shadow-indigo-500/10' 
        : 'bg-white/5 border-white/10 hover:border-white/20 text-gray-300'
    }`}
  >
    <div className="flex items-start gap-4">
      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 transition-colors ${
        selected ? 'bg-white/10 text-brand-gradient' : 'bg-white/5 text-gray-500 group-hover:text-brand-gradient'
      }`}>
        <Icon size={24} />
      </div>
      <div className="space-y-1">
        <p className="font-bold text-lg">{label}</p>
        <p className={`text-sm font-light leading-relaxed ${selected ? 'text-gray-300' : 'text-gray-500'}`}>
          {desc}
        </p>
      </div>
      {selected && (
        ...
        <AnimatePresence mode="wait">
          {step !== 'success' ? (
            ...
            >
              ...
              <div className="min-h-[400px]">
                <AnimatePresence mode="wait">
                  {step === 1 && (
                    ...
                    >
                      <div className="space-y-2 text-center">
                        ...
                        <p className="text-gray-400 font-light">What is the primary bottleneck in your business right now?</p>
                      </div>
                          ...
                          >
                            <div className="space-y-2 max-w-2xl mx-auto pt-4">
                              <label className="text-xs font-bold text-white uppercase tracking-widest flex items-center gap-2">
                                <MessageSquare size={14} className="text-gray-400" /> Please specify
                              </label>
                              <textarea 
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 transition-all min-h-[100px] resize-none"
                              />
                            </div>
                          </motion.div>
                        )}
                  ...
                  {step === 2 && (
                    ...
                    >
                      <div className="space-y-2 text-center">
                        ...
                        <p className="text-gray-400 font-light">What does success look like in 6 months?</p>
                      </div>
                      <div className="max-w-2xl mx-auto space-y-6">
                        <div className="space-y-2">
                          <label className="text-xs font-bold text-white uppercase tracking-widest flex items-center gap-2">
                            <Target size={14} className="text-gray-400" /> Your Goal
                          </label>
                          <textarea 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 transition-all min-h-[180px] resize-none"
                          />
                        </div>
                      </div>
                    </motion.div>
                  ...
                  {step === 3 && (
                    ...
                    >
                      <div className="space-y-2 text-center">
                        <h2 className="text-3xl font-bold text-white">Readiness</h2>
                        <p className="text-gray-400 font-light">Current Monthly Marketing Budget</p>
                      </div>
                  ...
                  {step === 4 && (
                    ...
                    >
                      <div className="space-y-2 text-center">
                        ...
                        <p className="text-gray-400 font-light">Where should I send my initial thoughts?</p>
                      </div>
                      <div className="max-w-md mx-auto space-y-8">
                        <div className="space-y-3">
                          <label className="text-xs font-bold text-white uppercase tracking-widest flex items-center gap-2 mb-1">
                          ...
                          <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 transition-all"
                          />
                        </div>
                        <div className="space-y-3">
                          <label className="text-xs font-bold text-white uppercase tracking-widest flex items-center gap-2 mb-1">
                            <Mail size={14} className="text-gray-400" /> Work Email
                          </label>
                          <input 
                            required
                            type="email"
                        ...
                        <div className="space-y-3">
                          <label className="text-xs font-bold text-white uppercase tracking-widest flex items-center gap-2 mb-1">
                            <LinkIcon size={14} className="text-gray-400" /> Company URL
                          </label>
                          <input 
                            required
                            type="url"
              ...
              {/* Navigation Buttons */}
              <div className="flex items-center justify-between max-w-md mx-auto pt-8 border-t border-white/10">
                {step > 1 ? (
                  <button 
                    onClick={prevStep}
                ...
                {step < 4 ? (
                  <button 
                    ...
                    onClick={nextStep}
                    className="px-10 py-5 bg-white/10 text-white font-bold rounded-2xl hover:bg-white/20 border border-white/10 transition-all flex items-center gap-2 disabled:opacity-50 disabled:hover:bg-white/10"
                  >
                    Next Step
                    <ArrowRight size={20} />
                  </button>
                  ...
                  <button 
                    ...
                    className="px-10 py-5 bg-brand-gradient text-zinc-900 font-bold rounded-2xl hover:brightness-110 transition-all flex items-center gap-2 shadow-xl shadow-indigo-500/20 disabled:opacity-50"
                  >
            ...
            >
              <div className="w-24 h-24 rounded-[2.5rem] bg-white/5 text-brand-gradient flex items-center justify-center mx-auto shadow-xl shadow-indigo-500/10">
                <CheckCircle2 size={48} />
              </div>
              <div className="space-y-4">
                <h2 className="text-5xl font-bold text-white tracking-tight">Got it, {formData.name.split(' ')[0]}.</h2>
                <p className="text-xl text-gray-400 font-light max-w-xl mx-auto leading-relaxed">
              ...
              <div className="max-w-2xl mx-auto text-left">
                <div className="bg-white/5 rounded-[2rem] p-10 border border-white/10 backdrop-blur-md space-y-8">
                  <h3 className="text-xl font-bold text-white font-mono tracking-tight uppercase">How It Works</h3>
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-white/10 shadow-sm flex items-center justify-center font-bold text-white shrink-0 border border-white/20 text-sm">1</div>
                      <p className="text-gray-400 text-lg pt-1"><strong className="text-white">Review:</strong> I look at your details to ensure we are a good fit for each other.</p>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-white/10 shadow-sm flex items-center justify-center font-bold text-white shrink-0 border border-white/20 text-sm">2</div>
                      <p className="text-gray-400 text-lg pt-1"><strong className="text-white">Discovery Call:</strong> We jump on a 30-minute discovery call (no sales pitch, just strategy and identifying levers).</p>
                    </div>
                    <div className="flex gap-4">
                      <div className="w-8 h-8 rounded-full bg-white/10 shadow-sm flex items-center justify-center font-bold text-white shrink-0 border border-white/20 text-sm">3</div>
                      <p className="text-gray-400 text-lg pt-1"><strong className="text-white">The Blueprint:</strong> If it makes sense, I build your custom automated growth blueprint.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
                <Link 
                  to="/portfolio"
                  className="px-10 py-5 bg-white/10 text-white font-bold rounded-2xl hover:bg-white/20 transition-all border border-white/20 shadow-xl flex items-center gap-2"
                >
                  View Case Studies
                ...
                <a 
                  ...
                  className="px-10 py-5 bg-brand-gradient text-zinc-900 font-bold rounded-2xl hover:brightness-110 transition-all shadow-xl shadow-indigo-500/20 flex items-center gap-2"
                >
