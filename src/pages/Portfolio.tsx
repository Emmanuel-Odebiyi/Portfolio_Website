    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        <div className="max-w-4xl space-y-8">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold tracking-tight text-zinc-900 leading-[1.05]">
            ...
            <span className="text-zinc-300">Here It Is.</span>
          </h1>
            ...
            >
              <div className={`space-y-10 relative z-10 ${i % 2 === 1 ? 'lg:order-2' : ''}`}>
                <div className="space-y-4">
                  ...
                  <h3 className="text-3xl md:text-5xl font-bold text-zinc-900 leading-snug">
                    {project.subtitle}
                  </h3>
      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        <div className="text-center space-y-4 mb-20">
          ...
          <h3 className="text-4xl font-bold text-zinc-900 tracking-tight">More Client Results</h3>
        </div>
