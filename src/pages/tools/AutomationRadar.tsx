                ...
                <div className="space-y-6 pt-4">
                  ...
                  <div className="space-y-4">
                    <input 
                      ...
                      className="w-full h-2 bg-zinc-100 rounded-lg appearance-none cursor-pointer accent-deep-space-blue-500"
                    />
                  ...
                  <div className="bg-zinc-900 rounded-[4rem] p-12 md:p-24 text-center space-y-12 relative overflow-hidden">
                    <div className="relative z-10 space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-8">
                        <div className="space-y-2">
                          <p className="text-6xl font-bold text-deep-space-blue-400 tracking-tighter">{results.hoursSaved * 12}</p>
